...
import org.guillermomolina.i4gl.runtime.exceptions.OutOfMemoryException;
import org.guillermomolina.i4gl.runtime.exceptions.SegmentationFaultException;
 ...
 */
public class I4GLHeap {

    /**
     * The singleton instance of the heap.
     */
    private static I4GLHeap INSTANCE = new I4GLHeap();
    ...
    public static I4GLHeap getInstance() {
        return INSTANCE;
    }
