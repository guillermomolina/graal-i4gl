...
/**
 * Exception thrown when a user provides invalid argument for the logarithm function ({@link org.guillermomolina.i4gl.nodes.builtin.arithmetic.LnBuiltinNode}).
 */
