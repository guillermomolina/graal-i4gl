...
import org.guillermomolina.i4gl.runtime.exceptions.*;
...
public class ObjectFileValue implements FileValue {
    ...
    public Object read() {
        try {
            ...
            throw new I4GLRuntimeException("Unexpected exception thrown while reading from a file");
        } catch (ClassNotFoundException e) {
            throw new I4GLRuntimeException("Wrong data in an input file");
        }
    }
    ...
    public void write(Object value) {
        try {
            ...
            throw new I4GLRuntimeException("Unexpected exception thrown while writing to a file");
        }
    }
    ...
    public boolean eof() {
        try {
            ...
            throw new I4GLRuntimeException("Unexpected exception thrown while reading a file");
        }
    }
    ...
    public void openToRead() {
        ...
        try {
            ...
            throw new org.guillermomolina.i4gl.runtime.exceptions.FileNotFoundException(this.filePath);
        } catch (IOException e) {
            throw new I4GLRuntimeException("Unexpected exception while opening a file");
        }
    }
