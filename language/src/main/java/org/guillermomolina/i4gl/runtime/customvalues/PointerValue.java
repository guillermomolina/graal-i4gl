...
import org.guillermomolina.i4gl.runtime.heap.HeapSlot;
import org.guillermomolina.i4gl.runtime.heap.I4GLHeap;
...
public class PointerValue {
    ...
    public Object getDereferenceValue() {
        return I4GLHeap.getInstance().getValueAt(this.heapSlot);
    }
    ...
    public void setDereferenceValue(Object value) {
        I4GLHeap.getInstance().setValueAt(this.heapSlot, value);
    }
