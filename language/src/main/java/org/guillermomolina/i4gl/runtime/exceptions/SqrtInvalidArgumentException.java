...
/**
 * Exception thrown when a user provides invalid argument for the square root function ({@link org.guillermomolina.i4gl.nodes.builtin.arithmetic.SqrtBuiltinNode}).
 */
