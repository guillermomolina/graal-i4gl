 ...
 */
@TypeSystem({ int.class, long.class, boolean.class, char.class, double.class, I4GLSubroutine.class, I4GLString.class,
        EnumValue.class, I4GLArray.class, Reference.class, PointerValue.class, SetTypeValue.class, FileValue.class, })
