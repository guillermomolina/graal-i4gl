 ...
 * SOFTWARE.
 */
package com.guillermomolina.i4gl.tck;
...
public class I4GLTCKLanguageProvider implements LanguageProvider {
    private static final String ID = "4gl";
    ...
    public Collection<? extends Snippet> createScripts(Context context) {
        final Collection<Snippet> res = new ArrayList<>();
        res.add(loadScript(context, "resources/Ackermann.4gl", TypeDescriptor.NULL, null));
        res.add(loadScript(context, "resources/Fibonacci.4gl", TypeDescriptor.NULL, null));
        return Collections.unmodifiableCollection(res);
    }
    ...
    public Collection<? extends Source> createInvalidSyntaxScripts(Context context) {
        try {
            ...
            res.add(createSource("resources/InvalidSyntax01.4gl"));
            res.add(createSource("resources/InvalidSyntax02.4gl"));
            return Collections.unmodifiableCollection(res);
    ...
    private static Source createSource(final String resourceName) throws IOException {
        ...
        try (Reader in = new InputStreamReader(I4GLTCKLanguageProvider.class.getResourceAsStream(resourceName), "UTF-8")) {
